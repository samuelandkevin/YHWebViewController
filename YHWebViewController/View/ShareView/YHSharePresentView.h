...
typedef NS_ENUM(NSInteger,ShareType){
    ...
    ShareType_Card,     //名片
    ShareType_News,     //咨讯
    ShareType_Tabbar    //Tabbar（点击Tabbar中间按钮显示菜单选项）
};
...
@property (nonatomic,assign) CGFloat cancelBtnH;//“取消”按钮高度
@property (nonatomic,assign) BOOL customcancelBtn;//自定义”取消“按钮,默认是NO
